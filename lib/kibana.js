...
export class Kibana {
    ...
    async downloadArtifact(artifactRelativeUrl) {
        // download artifact
        // const downloadResponse = await this.request(`${this.getUrlWithNoAuth()}${artifactRelativeUrl}`, {
        //     headers: {
        //         'kbn-xsrf': 'xxx',
        ...
        const artifactBodyBuffer = Buffer.from(responseJson.hits.hits["0"]._source.body, 'base64');
