...
export class Kibana {
     ...
     * @returns {Promise<{number: string, build_snaptshot: boolean, build_number: number, build_hash: string}>}
     */
    ...
    async getAnyFleetAgent(agentConfigId) {
        ...
        //      FIXME: if an agent already exists, is there a way to get is API key? we do have the API key id.
